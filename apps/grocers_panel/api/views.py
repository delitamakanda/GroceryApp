...
from apps.grocers_panel.models import Grocer, Rating, Shop
from apps.grocers_panel.api.serializers import GrocerSerializer, ShopSerializer, RatingSerializer, OfferSerializer
